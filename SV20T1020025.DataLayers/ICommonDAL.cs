...
namespace SV20T1020025.DataLayers
{
    /// <summary>
    ...
    public interface ICommonDAL<T> where T : class
    {
        ...
        /// (trả về giá trị 0 nếu việc bổ sung dữ liệu không thành công)
        /// </summary>
        ...
        T? Get(int id);
        /// <summary>
        /// kiểm tra xem dữ liệu bản ghi dữ liệu có mã id hiện đang có sử dụng đang có được sử dụng bởi các dữ liệu khác hay không?
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        bool IsUsed(int id);
